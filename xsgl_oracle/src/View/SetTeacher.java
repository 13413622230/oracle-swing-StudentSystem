 ...
 * @author  __USER__
 */
public class SetTeacher extends javax.swing.JFrame {

	/** Creates new form SetTeacher */
	public SetTeacher(String[] str) {
		initComponents();
		jTextField1.setText(str[1]);
		jTextField2.setText(str[0]);
		jComboBox1.setSelectedItem(str[2]);
		jTextField3.setText(str[3]);
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (tea_name == null || tea_name.isEmpty()) {
			...
			Teacher teacher = new Teacher(tea_id, tea_pw, tea_name, tea_sex,
					tea_age);
			if (new OperateOracle().UpdateTeacher(teacher)) {
				JOptionPane.showMessageDialog(this, "更改教师成功！");
			} else
				JOptionPane.showMessageDialog(this, "更改教师失败，请检查ID是否正确！");
		}
	}
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new SetTeacher(null).setVisible(true);
			}
		});
	}
